...
//Ниже продеймонстрированы различные способы создания объекта//
    ...
    library.get_film("Терминатр", 1992)->year = 2000; //Пример использования метода поиска фильма
    library.get_film("Терминатр", 2000)->year = 1992;//C последующим изменением компонентов найденого фильма
