...
public:
    SnakeGame() : snake(Snake()), field(Field()), fruit(Fruit()), mode(HARD) {}
    SnakeGame(Field f, Snake s, Fruit fr, Mode m) : mode(m), field(f), snake(s), fruit(fr) {  }
